...
# Introduction
An API sample showing how to create a basic Microservices architecture application, 
and implement the CRUD operations with Pagination using Spring Data repositories, all in Kotlin.

# What you will learn:
- Java
- Spring Boot
- Spring Data
- Spring Cloud with Zuul
- Hql
- Pagination
- Sorting
- Full CRUD
